// Лабиринтовый редьюсер. Для каждого добавления в хранилище есть соответствующий экшн с его очищением
// Обычно я не использую один экшн для очищения всего хранилище, т.к. считаю такое решение недостаточно гибким
// А если держать оба варианта (и отдельные, и "массовый"), то стопроцентно начнется путаница
