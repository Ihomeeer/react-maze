...
// Обычно я не использую один экшн для очищения всего хранилище, т.к. считаю такое решение недостаточно гибки
// А если держать оба варианта (и отдельные, и "массовый"), то стопроцентно начнется путанница
